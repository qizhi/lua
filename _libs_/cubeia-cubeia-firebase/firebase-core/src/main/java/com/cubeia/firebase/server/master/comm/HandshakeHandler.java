...
public class HandshakeHandler extends BaseHandler<Handshake> {

	public Object handle(SocketAddress sender, Handshake com) throws InvocationTargetException, CommandException {
		ClusterParticipant node = com.getAttachment();
		MasterNode master = con.getNode();
		boolean answer = master.handshakeReceived(node);
