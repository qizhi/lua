...
public interface GameRevision {

	public abstract int getVersion();

	public abstract DeploymentResource getResource();

	public abstract GameDeploymentLayout getLayout();

	public abstract ClassLoader getRevisionClassLoader();

	public abstract GameDefinition getGameDefinition();

	public abstract Class<?> loadGameClass() throws ClassNotFoundException;

	public abstract Game newGameInstance() throws ClassNotFoundException,
