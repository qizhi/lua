...
/**
 * Simple test class for running a single empty service
 * within a pre-setup environment, such as eclipse.
 * 
...
public class ServerShell {
    ...
    public static void main(String[] args) {
    	try {
	    	...
	    	inst.init(checkId(args), checkInitFolder(args), new SharedClassLoader(ServerShell.class.getClassLoader()), null);
	    	inst.start();
