...
@Configurated(inheritance=Inheritance.ALLOW, namespace="server.statistics")
public interface StatisticsLevelConfig extends Configurable {
		
	@Property(defaultValue="PROFILING") public Level getLevel();
