...
public interface CrossOriginConfig extends Configurable {

	@Property(defaultValue="*")
	public StringList getAllowedOrigins();

	@Property(defaultValue="GET,POST")
	public StringList getAllowedMethods();

	@Property(defaultValue="Origin,Content-Type,Accept")
	public StringList getAllowedHeaders();
	
	@Property(defaultValue="1800")
