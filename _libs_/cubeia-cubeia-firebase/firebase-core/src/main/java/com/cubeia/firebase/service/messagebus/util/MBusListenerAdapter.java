...
/**
 * This is a trivial adapter class for the mbus listener interface. All
 * methods are implemented with an empty body.
 * 
 * @author Larsan
 */
public class MBusListenerAdapter implements MBusListener {
