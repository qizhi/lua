...
public class ManagerNodeContextImpl extends RoutingNodeContextImpl<ManagerNode> {

	ManagerNodeContextImpl(ClusterRole role, ManagerNode node, ServerInstance inst) {
