 ...
 * 
 * Will unsubscribe to *all* nodes contained under
 * the supplied node.
 *
 * @author Fredrik
 */
public class LobbyUnsubscriptionRequest {
	...
	public LobbyUnsubscriptionRequest(int playerid, LobbyPath path) {
		super();
	...
	public String toString() {
		return "LobbyUnsubscriptionRequest - pid["+playerid+"] fqn["+path+"] type["+type+"]";
	}
}
