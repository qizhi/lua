...
@Configurated(namespace="my.ns",inheritance=Inheritance.DENY)
public interface TestInheritIFaceTwo extends Configurable {

	public String getStringOne();
	
	@Property(inheritance=Inheritance.ALLOW)
