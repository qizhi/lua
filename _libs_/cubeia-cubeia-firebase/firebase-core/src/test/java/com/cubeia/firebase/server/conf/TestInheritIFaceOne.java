...
@Configurated(namespace="my.ns",inheritance=Inheritance.ALLOW)
public interface TestInheritIFaceOne extends Configurable {

	@Property(defaultValue="kallet")
	public String getStringOne();
	
	@Property(inheritance=Inheritance.DENY)
