=========================================================================
==  Welcome to Cubeia Firebase - Java Simple Text Client               ==
=========================================================================
...
Cubeia Firebase Java Simple Text Client is build with Maven 2. If you have a 
source distribution, you should simply have to enter the root directory 
with command window and execute:

 `mvn package`

This will compile all sources and package the Simple Text Client in a 
