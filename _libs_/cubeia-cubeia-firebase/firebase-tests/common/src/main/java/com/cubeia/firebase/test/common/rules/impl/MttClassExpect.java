...
public class MttClassExpect implements Expect {
	...
	public MttClassExpect(Class<?> cl, Serializer serializer) {
		this(cl, serializer, null);
	}
	
	public MttClassExpect(Class<?> cl, Serializer serializer, List<Attribute> attributes) {
	...
	public Action accept(Object o) {
		if(o instanceof MttTransportPacket) {
			MttTransportPacket p = (MttTransportPacket) o;
			byte[] bytes = p.mttdata;
			try {
	...
	private boolean checkAttributes(MttTransportPacket o) {
