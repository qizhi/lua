...
public class LinearGroupExpectTest {

	@Test
	public void testLinearSparseGroup() throws Exception {
		ObjectExpect one = new ObjectExpect("1");
		ObjectExpect two = new ObjectExpect("2");
		ObjectExpect four = new ObjectExpect("4");
		
		LinearGroupExpect e = new LinearGroupExpect(one, two, four);
		...
		Assert.assertEquals(e.accept("4"), Action.DONE);
	}
	
	@Test
	public void testLinearGroup() throws Exception {
		ObjectExpect one = new ObjectExpect("1");
		ObjectExpect two = new ObjectExpect("2");
		ObjectExpect four = new ObjectExpect("4");
	...
	@Test
	public void testLinearGroupFail() throws Exception {
		ObjectExpect one = new ObjectExpect("1");
		ObjectExpect two = new ObjectExpect("2");
		ObjectExpect four = new ObjectExpect("4");
		...
		Assert.assertEquals(e.accept("1"), Action.PASS_THROUGH);
		Assert.assertEquals(e.accept("3"), Action.PASS_THROUGH);
		Assert.assertEquals(e.accept("4"), Action.FAIL);
	}
}
