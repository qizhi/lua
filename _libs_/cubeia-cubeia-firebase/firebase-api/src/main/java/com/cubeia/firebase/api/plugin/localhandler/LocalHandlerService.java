 ...
 */
package com.cubeia.firebase.api.plugin.localhandler;
...
/**
 * Interface for service class performing player information
 * lookups.
 *
 * @author Fredrik
 */
public interface LocalHandlerService extends Contract {
