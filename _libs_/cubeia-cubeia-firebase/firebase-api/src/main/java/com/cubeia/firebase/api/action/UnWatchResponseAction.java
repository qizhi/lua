...
public class UnWatchResponseAction extends AbstractPlayerAction {

	private byte status;
	
    public UnWatchResponseAction(int tableId, int status) {
        super(-1, tableId);
    ...
    public String toString() {
    	return "Unwatch response - pid["+getPlayerId()+"] tid["+getTableId()+"] status["+status+"]";
    }
