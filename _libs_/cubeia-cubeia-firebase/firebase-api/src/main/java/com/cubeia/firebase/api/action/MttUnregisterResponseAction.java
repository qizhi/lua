...
public class MttUnregisterResponseAction extends AbstractMttAction {
    ...
    public MttUnregisterResponseAction(int playerId, int mttId, MttRegisterResponse status) {
        super(mttId);
        this.mttId = mttId;
        this.status = status;
    ...
    public String toString() {
        return "mtt register response action: pid[" + getPlayerId() + "] mttId[" + mttId + "] status[" + status.name()+"]";
    }
