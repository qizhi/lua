...
/**
 * A player requests detailed information about a table.
 * 
 */
public class TableQueryRequestAction extends AbstractPlayerAction {

	private static final long serialVersionUID = -2824279361177906228L;

	public TableQueryRequestAction(int playerId, int tableId) {
