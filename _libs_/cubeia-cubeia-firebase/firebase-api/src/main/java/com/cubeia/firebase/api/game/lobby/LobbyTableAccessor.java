 ...
 * mandates a root path for all table data, "/table/&lt;gameId&gt;/", which
 * enforces separation between games. It also enforces data type control.
 * 
 * @author lars.j.nilsson
 */
public interface LobbyTableAccessor extends LobbyAccessor { }
