...
public class TimeWindowCounter {
	...
	public TimeWindowCounter(long millis) {
        this.window = millis;
	}
	
	/**
	 * Added sycnhronization to avoid DCL issues.
	 * Until we see this emerge as a bottleneck I will keep it there.
	 * Agruably, accurate data is more important then raw performance
	 * in this stage of product development (1.0 RC1)
	 *
	 */
	public synchronized void register() {
		long t = System.currentTimeMillis();
		if(startTime.get() + window < t) {
			checkLimit(t);
		}
