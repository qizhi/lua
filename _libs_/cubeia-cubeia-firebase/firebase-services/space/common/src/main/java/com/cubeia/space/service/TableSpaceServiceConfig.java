...
public interface TableSpaceServiceConfig extends Configurable {

	@Property(defaultValue="500")
	public long getBuddyReorgDelay();
	
	@Property(defaultValue="10240")
	public long getTableSpaceObjectWarnSize();
	
	@Property(defaultValue="20480")
	public long getMttSpaceObjectWarnSize();
