...
public final class SimpleChannelPoolEvent extends ChannelEvent { 
	
	private static final long serialVersionUID = 559131529570758034L;
	
	private final SimpleChannelPooledHandoff handoff;

	SimpleChannelPoolEvent(Event<?> event, EventType type, int channel, SimpleChannelPooledHandoff handoff) {
