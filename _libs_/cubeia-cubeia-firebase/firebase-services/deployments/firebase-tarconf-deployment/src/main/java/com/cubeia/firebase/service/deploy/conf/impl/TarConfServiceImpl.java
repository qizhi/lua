...
public class TarConfServiceImpl implements Service, DeploymentHandlerService {
	
	private TarActivationConfigDeploymentHandler handler;

	public void init(ServiceContext con) throws SystemException { 
		this.handler = new TarActivationConfigDeploymentHandler(con.getParentRegistry());
	}
	...
	public DeploymentType getDeploymentType() {
		return DeploymentType.TOURNAMENT_ACTIVATOR_CONF;
	}
