...
public class TarActivationConfigDeploymentHandler extends ActivationConfigDeploymentHandler {

	public TarActivationConfigDeploymentHandler(ServiceRegistry registry) throws SystemCoreException {
		super(registry);
	}
	
	@Override
	public String getTail() {
		return Constants.TAR_ACTIVATION_CONFIG_DEF_TAIL;
	}
	
	@Override
	public ActivationType getType() {
		return ActivationType.TAR;
	}
}
