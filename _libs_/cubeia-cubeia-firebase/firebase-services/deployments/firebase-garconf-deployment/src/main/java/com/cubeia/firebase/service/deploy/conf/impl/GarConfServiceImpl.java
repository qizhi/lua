...
public class GarConfServiceImpl implements Service, DeploymentHandlerService {
	
	private GarActivationConfigDeploymentHandler handler;

	public void init(ServiceContext con) throws SystemException { 
		this.handler = new GarActivationConfigDeploymentHandler(con.getParentRegistry());
	}
	...
	public DeploymentType getDeploymentType() {
		return DeploymentType.GAME_ACTIVATOR_CONF;
	}
