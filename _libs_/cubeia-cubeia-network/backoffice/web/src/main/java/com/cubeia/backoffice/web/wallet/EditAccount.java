...
import com.cubeia.backoffice.web.util.DateDisplayModel;
...
public class EditAccount extends BasePage {
	 ...
	 *            Page parameters
	 */
    public EditAccount(PageParameters params) {
        final Long accountId = params.get(PARAM_ACCOUNT_ID).toLongObject();
        ...
        add(new LabelLinkPanel("transactionsLink", "View transactions", 
            TransactionList.class, ParamBuilder.params(TransactionList.PARAM_ACCOUNT_ID, account.getId())));
