...
import static com.cubeia.backoffice.web.wallet.AccountDetails.PARAM_ACCOUNT_ID;
...
import com.cubeia.backoffice.web.wallet.AccountDetails;
...
public class UserSummary extends BasePage {
    ...
    private boolean assertValidUserid(PageParameters params) {
    	try {
    		params.get("userId").toLongObject();
    		return true;
    	} catch (Exception e) {
